...
/**
 * Simple concrete implementation of {@link SolrQueryRequestBase} for use in tests. This class
 * provides convenient constructors for creating test requests.
 *
 * <p>This is a replacement for the deprecated {@code LocalSolrQueryRequest}.
 */
public class SimpleSolrQueryRequest extends SolrQueryRequestBase {
  ...
  public SimpleSolrQueryRequest(SolrCore core, Map<String, String[]> args) {
