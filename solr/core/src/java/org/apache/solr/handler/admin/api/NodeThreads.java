...
/**
 * V2 API implementation for triggering a thread dump on the receiving node.
 *
 * <p>This API (GET /v2/node/threads) is analogous to the v1 /admin/info/threads.
 */
public class NodeThreads extends JerseyResource implements NodeThreadsApi {

  @Override
  @PermissionName(PermissionNameProvider.Name.METRICS_READ_PERM)
  public SolrJerseyResponse getThreads() {
    ...
    response.setUnknownProperty("system", system);
