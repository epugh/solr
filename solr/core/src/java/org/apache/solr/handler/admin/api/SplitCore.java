...
/**
 * V2 API implementation for splitting a core into multiple pieces.
 *
 * <p>This API (POST /v2/cores/coreName/split) is analogous to the v1 /admin/cores?action=split
 * command.
 */
public class SplitCore extends CoreAdminAPIBase implements SplitCoreApi {
  ...
  public SolrJerseyResponse splitCore(String coreName, SplitCoreRequestBody requestBody)
    ...
    if (requestBody != null) {
      ...
      if (requestBody.splitMethod != null) {
        v1Params.put("splitMethod", requestBody.splitMethod);
      }
      if (requestBody.getRanges != null) {
        v1Params.put("getRanges", requestBody.getRanges);
      }
