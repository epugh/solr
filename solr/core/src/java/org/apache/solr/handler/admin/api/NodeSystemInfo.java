...
/**
 * V2 API implementation for retrieving system information from a node.
 *
 * <p>This API (GET /v2/node/system) is analogous to the v1 /admin/info/system.
 */
public class NodeSystemInfo extends JerseyResource implements NodeSystemInfoApi {
  ...
  public SolrJerseyResponse getSystemInfo() throws Exception {
    ...
    for (Map.Entry<String, ?> entry : solrQueryResponse.getValues()) {
