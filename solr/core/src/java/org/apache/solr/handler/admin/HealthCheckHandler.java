...
public class HealthCheckHandler extends RequestHandlerBase {
  ...
  public void handleRequestBody(SolrQueryRequest req, SolrQueryResponse rsp) throws Exception {
    ...
    final NodeHealth nodeHealthApi = new NodeHealth(coreContainer);
    final Boolean requireHealthyCores = req.getParams().getBool("requireHealthyCores", false);
    final Integer maxGenerationLag =
        req.getParams()
            .getInt(
                org.apache.solr.client.solrj.request.HealthCheckRequest.PARAM_MAX_GENERATION_LAG);
    V2ApiUtils.squashIntoSolrResponseWithoutHeader(
        rsp, nodeHealthApi.getHealth(requireHealthyCores, maxGenerationLag));
  }
