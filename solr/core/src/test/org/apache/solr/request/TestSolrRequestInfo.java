...
public class TestSolrRequestInfo extends SolrTestCaseJ4 {
  ...
  public void testCloseHookTwice() {
    final SolrRequestInfo info =
        new SolrRequestInfo(
            new SimpleSolrQueryRequest(h.getCore(), params()), new SolrQueryResponse());
  ...
  public void testLimitsMaintained() {
    try {
      SimpleSolrQueryRequest timeAllowed1000 =
          new SimpleSolrQueryRequest(h.getCore(), params("timeAllowed", "1000"));
      SimpleSolrQueryRequest timeAllowed20000 =
          new SimpleSolrQueryRequest(h.getCore(), params("timeAllowed", "20000"));
