...
/** Unit tests for {@link OverseerOperation} */
public class OverseerOperationAPITest extends SolrTestCaseJ4 {

  private OverseerOperation api;
  ...
  public void setUp() throws Exception {
    ...
    api = new OverseerOperation(mockCoreContainer, realRequest, queryResponse);
  }

  @Test
  public void testAllParamsPassedCorrectly() throws Exception {
    final var requestBody = new OverseerOperationRequestBody();
    requestBody.op = "rejoinAtHead";
    requestBody.electionNode = "someNode";

    api.overseerOperation(requestBody);
    ...
    assertEquals("overseerop", params.get(ACTION));
    assertEquals("rejoinAtHead", params.get("op"));
    assertEquals("someNode", params.get("electionNode"));
  }
}
