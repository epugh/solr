...
/** Unit tests for {@link RequestApplyCoreUpdates} */
public class RequestApplyCoreUpdatesAPITest extends SolrTestCaseJ4 {

  private RequestApplyCoreUpdates api;
  ...
  public void setUp() throws Exception {
    ...
    api = new RequestApplyCoreUpdates(mockCoreContainer, asyncTracker, realRequest, queryResponse);
  }

  @Test
  public void testReportsErrorIfCoreNameMissing() {
    final SolrException thrown =
        expectThrows(SolrException.class, () -> api.requestApplyCoreUpdates(null));
  ...
  public void testPassesParamsCorrectly() throws Exception {
    api.requestApplyCoreUpdates("someCore");
    ...
    assertEquals("requestapplyupdates", params.get(ACTION));
    assertEquals("someCore", params.get(NAME));
  }
}
