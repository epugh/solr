...
/** Unit tests for {@link RequestBufferUpdates} */
public class RequestBufferUpdatesAPITest extends SolrTestCaseJ4 {

  private RequestBufferUpdates api;
  ...
  public void setUp() throws Exception {
    ...
    api = new RequestBufferUpdates(mockCoreContainer, asyncTracker, realRequest, queryResponse);
  }

  @Test
  public void testReportsErrorIfCoreNameMissing() {
    final SolrException thrown =
        expectThrows(SolrException.class, () -> api.requestBufferUpdates(null));
  ...
  public void testPassesParamsCorrectly() throws Exception {
    api.requestBufferUpdates("someCore");
    ...
    assertEquals("requestbufferupdates", params.get(ACTION));
