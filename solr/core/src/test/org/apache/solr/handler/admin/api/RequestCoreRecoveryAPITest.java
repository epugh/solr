...
/** Unit tests for {@link RequestCoreRecovery} */
public class RequestCoreRecoveryAPITest extends SolrTestCaseJ4 {

  private RequestCoreRecovery api;
  ...
  public void setUp() throws Exception {
    ...
    api = new RequestCoreRecovery(mockCoreContainer, asyncTracker, realRequest, queryResponse);
  }

  @Test
  public void testReportsErrorIfCoreNameMissing() {
    final SolrException thrown =
        expectThrows(SolrException.class, () -> api.requestCoreRecovery(null));
  ...
  public void testPassesParamsCorrectly() throws Exception {
    api.requestCoreRecovery("someCore");
    ...
    assertEquals("requestrecovery", params.get(ACTION));
