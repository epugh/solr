...
public class MoreLikeThisComponentTest extends SolrTestCaseJ4 {
  ...
  public void testMLT_baseParams_shouldReturnSimilarDocuments() {
    ...
    SolrQueryRequest mltreq = new SimpleSolrQueryRequest(core, params);
    assertQ(
    ...
    mltreq.close();
    mltreq = new SimpleSolrQueryRequest(h.getCore(), params);
  ...
  public void testMLT_debugEnabled_shouldReturnSimilarDocumentsWithDebug() {
    ...
    SolrQueryRequest mltreq = new SimpleSolrQueryRequest(h.getCore(), params);
    assertQ(
