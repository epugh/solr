...
On xref:cluster-types.adoc#solrcloud-mode[SolrCloud] nodes, an additional pulldown list shows all collections in this cluster.
...
[NOTE]
====
The Schema Designer is only available on Solr instances running xref:cluster-types.adoc#solrcloud-mode[SolrCloud].
====
...
[NOTE]
====
The Collection Selector pull-down menu is only available on Solr instances running xref:cluster-types.adoc#solrcloud-mode[SolrCloud].
