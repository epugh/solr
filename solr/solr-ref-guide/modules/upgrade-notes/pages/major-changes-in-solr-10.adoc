...
Overwrite made sense when uploading a complete configset and you wanted to eliminate any remnants configset files when you added a new one.  but for single file it has no bearing.
