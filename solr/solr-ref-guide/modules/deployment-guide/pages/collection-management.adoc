...
[source,bash]
----
curl -X POST http://localhost:8983/api/collections/techproducts_v2/modify -H 'Content-Type: application/json' -d '
  {
    "replicationFactor": 2
  }
'
...
[source,bash]
----
curl -X POST http://localhost:8983/api/collections/techproducts_v2/migrate -H 'Content-Type: application/json' -d '
  {
...
[source,bash]
----
curl -X POST http://localhost:8983/api/collections/techproducts/rebalance-leaders -H 'Content-Type: application/json' -d '
  {
    "maxAtOnce": 3
  }
'
